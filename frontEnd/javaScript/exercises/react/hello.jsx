class Hello extends React.Component {
    ...
    getArtist(artistName){
        fetch("http://ws.audioscrobbler.com/2.0/?method=artist.getInfo&artist=" + artistName + "&api_key=d3e7cbd8223a021b7efdce3f7c547977&format=json").than((response) => {
            response.json().than((result) => {
